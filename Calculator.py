...
#adding others button to the calculator
...
#adding the operational operator
...
#adding some new operation
Button(root, text="pi",command = lambda : get_operation("*3.1416")).grid(row =2, column=4)
...
Button(root, text="<-",command = lambda :undo()).grid(row =3, column=5)
Button(root, text="^2",command = lambda : get_operation("**2")).grid(row =4, column=5)
Button(root, text="x!").grid(row =5, column=5)
